...
- Maestro запускает собранный APK на существующем `Pixel_3a_API_34`: открыть приложение, выбрать `Thai formal` и мужской пол, перевести `Спасибо`, проверить `ขอบคุณครับ` и обе транслитерации. [Expo Maestro E2E](https://docs.expo.dev/eas/workflows/examples/e2e-tests/).
...
- Собрать web production bundle, Docker image и локальный preview APK, установить APK на эмулятор и прогнать полный Maestro flow.
